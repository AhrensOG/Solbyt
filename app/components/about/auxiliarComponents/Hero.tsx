...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative top-[77px] min-h-[calc(100vh-77px)] py-10 pb-20 bg-white overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col gap-5 divide-y">
          <div>
            {/* Badge */}
            <motion.div
          ...
          <motion.div
            ...
            {stats.map((stat, index) => (
              <motion.div
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 group-hover:border-gray-200">
