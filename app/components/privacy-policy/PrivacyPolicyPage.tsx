          ...
          <div className="max-w-4xl mx-auto space-y-10 divide-y divide-gray-200">
            <div className="pb-6">
              <p className="text-lg text-gray-700">
                ...
                cómo recopilamos, usamos y protegemos la información personal
                que usted nos proporciona a través de nuestro formulario de
                contacto. Al utilizar nuestro sitio web, usted acepta las
            ...
            <div className="pt-6">
              ...
              <p className="text-gray-700 text-lg">
                ...
                del formulario de contacto, tales como su nombre completo,
                correo electrónico, el sector o área en la que opera su negocio
                y, opcionalmente, un mensaje.
              </p>
            </div>
            <div className="pt-6">
              <h2 className="text-2xl font-semibold text-solbyt-gray-800  mb-2">
            ...
            <div className="pt-6">
              ...
              <p className="text-gray-700 text-lg">
                Nos comprometemos a proteger la seguridad de sus datos
                personales mediante el uso de medidas técnicas y organizativas
                adecuadas. Aunque no podemos garantizar una seguridad absoluta,
                implementamos procedimientos y protocolos para minimizar los
                riesgos de pérdida, acceso no autorizado o divulgación de su
                información.
              </p>
            </div>
            <div className="pt-6">
              ...
              <p className="text-gray-700 text-lg">
                ...
                para cumplir con los fines para los cuales fueron recogidos, o
                según lo exijan las leyes y regulaciones aplicables. Una vez que
                la información ya no sea necesaria, tomamos medidas razonables
            ...
            <div className="pt-6">
              ...
              <p className="text-gray-700 text-lg">
                ...
                circunstancias. Para ejercer estos derechos, por favor
                contáctenos a través de nuestro formulario de contacto o envíe
                un correo a: contacto@solbyt.com.
              </p>
            </div>
            <div className="pt-6">
              <h2 className="text-2xl font-semibold text-solbyt-gray-800  mb-2">
              ...
              <p className="text-gray-700 text-lg">
                ...
                efectivas a partir de su publicación en el sitio web, por lo que
